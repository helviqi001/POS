...
import { SUPPLIER_STATE, ReturnReducer } from './ReturnReducer';


const DetailReturn= ({ id , openModal , handleCloseModal})=>{
    ...
    const cookie = cookies.get("Authorization")
      ...
      useEffect(()=>{
        setLoading(true)
        const getData= async()=>{
          await axios.get(`http://localhost:8000/api/returns/${id}?relations=products`,{
            headers:{
