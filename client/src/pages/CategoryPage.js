...
// components
import CreateSupplier from '../sections/@dashboard/category/createform';
import EditForm from '../sections/@dashboard/category/editForm';
...
const TABLE_HEAD = [
  { id: 'itemType', label: 'Item Type', alignCenter: true },
  { id: '' },
];
