...
// components
import CreatePosition from '../sections/@dashboard/position/createform';
import EditPosition from '../sections/@dashboard/position/editForm';
        ...
        <MenuItem sx={{ color: 'error.main' }} onClick={handleDelete}> 
          ...
          Delete
              ...
              {openModal && (
                  <>
                      {create && (
                          <CreatePosition style2={style2} openModal={openModal} handleCloseModal={handleCloseModal} productList={productList} />
                      )}
                      {edit && (
                          <EditPosition id={id} style2={style2} openModal={openModal} handleCloseModal={handleCloseModal} productList={productList} />
                      )}
                  </>
              )}
        </>
